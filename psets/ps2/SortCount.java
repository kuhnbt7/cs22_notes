...
public class SortCount {
    ...
    public static void bubbleSort2(int[] arr) {
        ...
        for (int i = arr.length - 1; i > 0; i--) {
            ...
            if (!swapped){   // if there were no swaps for an entire pass, the array is sorted
                return;
            }
    ...
    public static void main(String args[]) {
        ...
        // compute statistics for bubbleSort2
        
        System.out.println("Statistics for bubbleSort2");
        ...
        for (int size: arraySizes){
            ...
            for (int i = 0; i < 10; i++){
                ...
                sumMoves += moves;
                sumComparisons += compares;
            }
            float avgComparisons = sumComparisons / 10;
            float avgMoves = sumMoves / 10;
            System.out.println("Array size: " + size + " " + avgComparisons + " average comparisons, " + avgMoves + " average moves");
